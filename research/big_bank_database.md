### Noon Sweep - Tuesday, April 14, 2026

#### 1. Big Four Market Performance
- **JPMorgan Chase (JPM):** EPS $5.94 (Beat), Net Income $16.5B. Price: $311.98 (-0.54%).
- **Citigroup (C):** EPS $3.06 (Beat), Revenue $24.63B (Beat). Price: $130.44 (+3.29%).
- **Wells Fargo (WFC):** EPS $1.60 (Beat), Revenue $21.45B (Miss). Price: $82.24 (-5.08%).
- **Bank of America (BAC):** Price: $53.37 (+0.04%). Pre-earnings mode.

#### 2. Strategic Intelligence (Project Orion Context)
- **Anthropic / Claude Mythos:** Treasury and Fed officials met with Wall Street executives regarding cybersecurity risks posed by Anthropic's "Claude Mythos" model.
- **Project Glasswing:** Access to Mythos remains restricted to major firms under Project Glasswing to protect critical infrastructure from OS-level exploitation risks.
- **AI Agent Disruption:** Ongoing monitoring of bank reactions to frontier model "cyber capabilities" as it relates to the Orion Model Council's ClawRouter and latency reduction initiatives.
